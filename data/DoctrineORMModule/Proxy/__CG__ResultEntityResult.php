...
class Result extends \Result\Entity\Result implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     */
    public static $lazyPropertiesDefaults = ['homeAway' => NULL, 'goals' => 0, 'goalsAgainst' => 0, 'points' => 1, 'shotOnTarget' => 0, 'totalShots' => 0, 'fouls' => 0, 'offside' => 0, 'possession' => 50, 'corners' => 0, 'tackles' => 0, 'yellowCards' => 0, 'redCards' => 0, 'injuries' => 0, 'shotAccuracy' => 0, 'passAccuracy' => 0];
    ...
    {
        unset($this->homeAway, $this->goals, $this->goalsAgainst, $this->points, $this->shotOnTarget, $this->totalShots, $this->fouls, $this->offside, $this->possession, $this->corners, $this->tackles, $this->yellowCards, $this->redCards, $this->injuries, $this->shotAccuracy, $this->passAccuracy);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Result\\Entity\\Result' . "\0" . 'id', 'homeAway', 'goals', 'goalsAgainst', 'points', 'shotOnTarget', 'totalShots', 'fouls', 'offside', 'possession', 'corners', 'tackles', 'yellowCards', 'redCards', 'injuries', 'shotAccuracy', 'passAccuracy', '' . "\0" . 'Result\\Entity\\Result' . "\0" . 'player', '' . "\0" . 'Result\\Entity\\Result' . "\0" . 'competition', '' . "\0" . 'Result\\Entity\\Result' . "\0" . 'season'];
        }
    ...
    public function getGoalsAgainst()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGoalsAgainst', []);

        return parent::getGoalsAgainst();
    }
    ...
    public function setGoalsAgainst($goalsAgainst)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setGoalsAgainst', [$goalsAgainst]);

        return parent::setGoalsAgainst($goalsAgainst);
    }
