 ...
 */
class TranslationIndex extends \Translator\Entities\TranslationIndex implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'index', '' . "\0" . 'Translator\\Entities\\TranslationIndex' . "\0" . 'translations', 'dateCreated', 'createdBy', 'dateChanged', 'changedBy', 'dateDeleted', 'deletedBy', 'deleted'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TranslationIndex $proxy) {
